...
const SOCIAL = [
    ...
    { id: "twitter", label: "Twitter", icon: <FaXTwitter size={16} color="#000000" /> },
...
const COUNTRIES = [
    ...
    { id: "sa", label: "Saudi Arabia", src: "saudiicon.svg", alt: "Saudi Arabia" },
    { id: "kw", label: "Kuwait", src: "kuwaiticon.svg", alt: "Kuwait" },
    { id: "ae", label: "United Arab Emirates", src: "emiratesicon.svg", alt: "UAE" },
...
export default function Footer() {
    return (
        <footer className="bg-[#fff] py-12" role="contentinfo" aria-label="Site footer">
            <div className="max-w-7xl mx-auto px-6">
                                        ...
                                        >
                                            {s.icon ? (
                                                ...
                                                <div className="w-5 h-5 bg-[#FFFC00] rounded flex items-center justify-center">
                                                    <img src={s.src} alt={s.alt} width={24} height={24} loading="lazy" />
                                                </div>
                                            ) : (
                                                <img src={s.src} alt={s.alt} width={20} height={20} loading="lazy" />
                                            )}
                                            <span>{s.label}</span>
                                        </a>
                                    </li>
                            ...
                            {COUNTRIES.map((c) => (
                                <li key={c.id}>
                                    <a
                                        ...
                                        onClick={(e) => e.preventDefault()}
                                    >
                                        <img src={c.src} alt={c.alt} width={20} height={20} loading="lazy" />
                                        <span>{c.label}</span>
                                    </a>
                                </li>
                            ))}
                ...
                <div className="mt-12 pt-8">
                    <div className="flex flex-col items-center justify-center space-y-4 mb-6">
                        <img src="award.svg" alt="World Travel Awards" width={200} height={200} loading="lazy" />
                    ...
                    <div className="text-center text-gray-600 text-sm mb-6">Copyright © 2025 Almosafer</div>

                    <div className="flex items-center justify-around space-x-8 text-xs text-gray-500">
                        <div className="text-center">
                            <div className="font-medium">Travel and Tourism Services License Permit Number:</div>
                            <div>73103013</div>
                        </div>
