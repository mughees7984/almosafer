...
const TravelBooking: React.FC = () => {
  ...
  return (
    <div className="min-h-[400px] md:min-h-[550px] bg-[url('hero.jpeg')] bg-cover bg-center bg-no-repeat relative">
      <div className="relative z-10 pt-6 md:pt-12 px-4 md:px-6 pb-8">
        {/* Header */}
        <div className="max-w-6xl mx-auto mt-6 md:mt-[60px]">
        ...
        {/* Main Card */}
        <div className="max-w-6xl mt-8 md:mt-[100px] mx-auto bg-white rounded-lg overflow-hidden shadow-2xl">
          {/* Tabs with Dark Background */}
          <div className="flex bg-gradient-to-r from-teal-700 to-teal-600">
            <button
              onClick={() => setActiveTab("flights")}
          ...
          <div className="p-4 md:p-6 bg-white">
            ...
            <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center md:flex-wrap">
              ...
              <div className="flex-1 min-w-0 md:min-w-48">
                <div className="flex items-center border-2 border-gray-300 rounded px-4 py-3 bg-white hover:border-gray-400 transition">
                  <Calendar size={18} className="text-gray-400 mr-3 flex-shrink-0" />
                  <input
                    type="text"
                    value={startDate}
                    onChange={(e) => setStartDate(e.target.value)}
