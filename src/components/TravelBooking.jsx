...
import { Plane, Hotel, MapPin, Calendar, Users, Search, X } from "lucide-react";

const TravelBooking = ()=>{
  const [tripType, setTripType] = useState("roundtrip");
  const [origin, setOrigin] = useState("");
  const [destination, setDestination] = useState("");
  const [startDate, setStartDate] = useState("Tue, 21 Oct");
  const [endDate, setEndDate] = useState("Wed, 22 Oct");
  ...
  return (
    <div className="min-h-[550px] bg-[url('hero.jpeg')] bg-cover bg-center bg-no-repeat relative">
      ...
      <div className="relative z-10 pt-12 px-6">
        ...
        {/* Main Card */}
        <div className="max-w-6xl mt-[180px] mx-auto bg-white rounded-lg overflow-hidden shadow-2xl">
